...
public static class ArrayMethods
{
    ...
    /// Implementation for <see href="https://docs.firebolt.io/sql_reference/functions-reference/aggregation/array-agg.html">ARRAY_AGG</see> Firebolt method
    /// </summary>
    /// <param name="_">Sequence on which should be performed</param>
    ...
    /// <returns>A new array with sorted elements.</returns>
    [Sql.Extension(DataProvider.V2Id, "ARRAY_SORT({lambda}, {array})", BuilderType = typeof(LambdaBuilder), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 3, ServerSideOnly = true)]
    ...
    /// <param name="lambda">Lambda for sort method</param>
    /// <returns>A new array with reverse sorted elements.</returns>
    [Sql.Extension(DataProvider.V2Id, "ARRAY_REVERSE_SORT({lambda}, {array})", BuilderType = typeof(LambdaBuilder), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 3, PreferServerSide = true)]
    ...
    /// <param name="lambda">Lambda for sort method</param>
    /// <returns>A new array with sorted elements.</returns>
    [Sql.Extension(DataProvider.V2Id, "ARRAY_TRANSFORM({lambda}, {array})", BuilderType = typeof(LambdaBuilder), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 10, IsAggregate = true, PreferServerSide = true)]
    ...
    [Sql.Extension(DataProvider.V2Id, "ARRAY_COUNT({lambda}, {array})", BuilderType = typeof(LambdaBuilder<bool>), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 10, IsAggregate = true, PreferServerSide = true)]
    ...
    [Sql.Extension(DataProvider.V2Id, "ARRAY_FILTER({lambda}, {array})", BuilderType = typeof(LambdaBuilder<bool>), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 10, ServerSideOnly = true)]
    ...
    /// <returns>Elements in the array that match the condition specified by the lambda expression.</returns>
    [Sql.Extension(DataProvider.V2Id, "ARRAY_FILTER({lambda}, {array}, {second})", BuilderType = typeof(LambdaBuilder<bool>), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 10, ServerSideOnly = true)]
    ...
    [Sql.Extension(DataProvider.V2Id, "ARRAY_ANY_MATCH({lambda}, {array})", BuilderType = typeof(LambdaBuilder<bool>), TokenName = AnalyticFunctions.FunctionToken,
        ChainPrecedence = 5)]
